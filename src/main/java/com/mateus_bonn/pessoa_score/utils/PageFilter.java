...
public class PageFilter {
    ...
    @Schema(name = "itemsPerPage", description = "valor máximo de itens por página")
     ...
     * Default value = 1
     */
    @Parameter(name = "pageIndex", description = "Numero da página")
    ...
    @Parameter(name = "orderBy", description = "Atributo da ordenação mais tipo de ordenação. Exemplo = name+asc")
     ...
     * Default value = ""
     */
    @Parameter(name = "search", description = "valor de filtro")
